...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="../img/extra_info/favicon.ico" type="image/x-icon">
    ...
    <body>
        ...
        <header>
            <div class="flex">
                <div class="logo">
                    <img src="../img/extra_info/logo-hmc.png" alt="logo">
                </div>
        ...
        <div class="wrapper extrainfo">
                ...
                <ul>
                    ...
                    <li><a onClick="show('#convection'); $('#submenu_1').hide(); $('#submenu_2').hide(); $('#submenu_3').show(); $('#submenu_4').show();">Описание прогностической продукции системы COSMO-Ru</a>
                        <ul id="submenu_3">
                            ...
                            <li><a href="#" onClick="show('#area'); $('#submenu_1').hide(); $('#submenu_2').hide();">Области счета конфигураций системы COSMO-Ru</a></li>
            ...
            <section class="extrainfo">
                ...
                <div id="cash">
                    ...
                    <figure>
                        <img src="../img/extra_info/cashChrome.png" alt="">
                    </figure>
                    ...
                    <figure>
                        <img src="../img/extra_info/cashFirefox.png" alt="">
                    </figure>
                ...
                <?php include "convection.php"; ?>

                <div id="area">
                    <h2>Области счета конфигураций системы COSMO-Ru</h2>
                    <h3>Суперкомпьютер SGI ICE-X</h3>
                    <figure>
                        <img src="../img/extra_info/area_1.png" alt="">
                    </figure>
                    <table>
                        <thead>
                            <tr>
                    ...
                    <figure>
                        <img src="../img/extra_info/area_3.png" alt="">
                    </figure>
                    <table>
                        <thead>
                            <tr>
