...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="../assets/img/extra_info/favicon.ico" type="image/x-icon">
        <link rel="stylesheet" href="../assets/css/one_workspace.css">
    ...
    <body>
        ...
        <header>
            <div class="flex">
                <div class="logo">
                    <img src="../assets/img/extra_info/logo-hmc.png" alt="logo">
                </div>

                <div class="main_text"><a href="http://u2019.meteoinfo.ru/services/cfo/index.php">Гидрометцентр России</a></div>
            </div>
            <div class="flex">
                ...
                <form class="form">
                    ...
                    <div class="radio-container">
                        <div class="form-item radio-btn nth-2">
                            <input type="radio" name="option1" id="radio1" value = "1" onchange="window.location.href = 'http://u2019.meteoinfo.ru/services/cfo/workspace_1.php?type=meteogram'; $(this).prop('checked', false);">
                            <label for="radio1">Одна</label>
                        </div>
                        <div class="form-item radio-btn nth-2">
                            <input type="radio" name="option1" id="radio2"  value = "2" onchange="window.location.href = 'http://u2019.meteoinfo.ru/services/cfo/workspace_2.php?type_1=map&type_2=map'; $(this).prop('checked', false);">
        ...
        <div class="wrapper extrainfo">
            ...
            <nav class="opened extrainfo">
                <ul>
                    <li>
                        <a onClick="show('#instraction'); $('#submenu_1').show(); $('#submenu_2').hide(); $('#submenu_3').hide();">Инструкция по пользованию сайтом</a>
                        <ul id="submenu_1">
                    ...
                    <li>
                        <a onClick="show('#cash'); $('#submenu_1').hide(); $('#submenu_2').show(); $('#submenu_3').hide();">Очистка кэш-памяти браузера</a>
                        <ul id="submenu_2">
                    ...
                    <li><a onClick="show('#convection'); $('#submenu_1').hide(); $('#submenu_2').hide(); $('#submenu_3').show(); $('#submenu_4').show();">Описание прогностической продукции системы COSMO-Ru</a>
                        <ul id="submenu_3">
                            <li><a href="#" onClick="show('#convection'); $('#submenu_1').hide(); $('#submenu_2').hide(); $('#submenu_3').show(); $('#submenu_4').show();">Параметры для оценки рисков опасных явлений, связанных с развитием конвекции</a>
                                <ul id="submenu_4">
                                    <li><a href="#cape">CAPE</a></li>
                                    <li><a href="#k-index">K-index</a></li>
                                    <li><a href="#li">Li</a></li>
                                    <li><a href="#tt">TT</a></li>
                                    <li><a href="#sweat">SWEAT</a></li>
                                    <li><a href="#swi">SI, SWI</a></li>
                                    <!-- <li><a href="#scp">SCP</a></li> -->
                                    <li><a href="#reflectability">Радиолокационная отражаемость</a></li>
                                    <li><a href="#lpi">LPI</a></li>
                                    <li><a href="#hail">HailCast</a></li>
            ...
            <section class="extrainfo">
                <?php include "../assets/extra_info/instraction_cfo.php"; ?>
                ...
                <div id="cash">
                    ...
                    <figure>
                        <img src="../assets/img/extra_info/cashChrome.png" alt="">
                    </figure>
                    ...
                    <figure>
                        <img src="../assets/img/extra_info/cashFirefox.png" alt="">
                    </figure>
                ...
                <?php include "../assets/extra_info/convection.php"; ?>

                <div id="area">
                    <h2>Области счета модели COSMO-Ru</h2>
                    <h3>Суперкомпьютер SGI ICE-X</h3>
                    <figure>
                        <img src="../assets/img/extra_info/area_1.png" alt="">
                    </figure>
                    <table>
                        <thead>
                            <tr>
                    ...
                    <figure>
                        <img src="../assets/img/extra_info/area_3.png" alt="">
                    </figure>
                    <table>
                        <thead>
                            <tr>
