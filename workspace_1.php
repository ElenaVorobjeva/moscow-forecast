    ...
    <body>
        <div class="header_wrapper">
            ...
            <nav class = "horizontal">
                <ul class="nav">
                    <?php
                        $url = "http://u2019.meteoinfo.ru/services/cfo/workspace_1.php?type=";
                    ...
                    ?>
                    <li><a href="http://u2019.meteoinfo.ru/services/cfo/table">Табличные данные</a></li>
                </ul>
            </nav>
        </div>
        <div class="wrapper">
            ...
            <?php if($_GET["type"] == "map") { ?>
                ...
                <script src="../assets/js/js1/map_ajax.js"></script>
            <?php } ?>
        ...
        <?php if($_GET["type"] == "meteogram") { ?>
            ...
            <script src="../assets/js/js1/meteo_ajax.js"></script>
